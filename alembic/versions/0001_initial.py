...
Creates all Arete tables matching the current SQLAlchemy models in
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("onboarding_answers") as batch_op:
        batch_op.create_unique_constraint(
            "uq_onboarding_answers_student_id", ["student_id"]
        )
