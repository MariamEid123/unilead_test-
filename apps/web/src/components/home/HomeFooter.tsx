...
export default function HomeFooter() {
  ...
  const hasSupportedCourse =
    student &&
    COURSE_CATALOG.some(
      (course) => course.code === student.course.code || course.title === student.course.title
    );
  ...
  return (
    <footer className="home-footer">
      <div className="home-footer__inner">
        <span className="home-footer__brand"><img src="/logo.jpg" alt="" /> Areta</span>
