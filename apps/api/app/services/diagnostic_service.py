...
CORRECT_ANSWERS = {
    "q1": "b",  # like charges repel; opposite charges attract
    "q2": "a",  # +3e — an integer multiple of e is the only possible charge
    "q3": "a",  # 0.5 μC = 0.5 × 10⁻⁶ C = 5 × 10⁻⁷ C
    "q4": "b",  # identical spheres share the conserved total equally: 3 C each
    "q5": "c",  # negative rod + grounding drains electrons → sphere is left positive
}
...
QUESTION_MISCONCEPTIONS = {
    "q1": "charge_interaction_rule_misunderstood",
    "q2": "quantization_misunderstood",
    "q3": "prefix_misconverted",
    "q4": "charge_conservation_misunderstood",
    "q5": "grounding_direction_misunderstood",
}
